...
export function PlayCardBar() {
  ...
  function onCardNoChange(e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) {
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <Box>
        <TextField value={cardNo ? cardNo : ''} onChange={onCardNoChange}></TextField>
...
function PlayDatePickerEx() {
  ...
  return (
    <>
      <DatePickButton value={value} onChange={(v: Date | null) => setValue(v)} />
